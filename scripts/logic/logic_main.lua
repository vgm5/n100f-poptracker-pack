...
scooby-doo!_night_of_100_frights_location = {}
scooby-doo!_night_of_100_frights_location.__index = scooby-doo!_night_of_100_frights_location
...
function scooby-doo!_night_of_100_frights_location.new(name)
    local self = setmetatable({}, scooby-doo!_night_of_100_frights_location)
    if name then
...
function scooby-doo!_night_of_100_frights_location:connect_one_way(exit, rule)
    if type(exit) == "string" then
        exit = scooby-doo!_night_of_100_frights_location.new(exit)
    end
    if rule == nil then
        rule = always
    end
...
function scooby-doo!_night_of_100_frights_location:connect_two_ways(exit, rule)
...
function scooby-doo!_night_of_100_frights_location:connect_one_way_entrance(name, exit, rule)
    if rule == nil then
        rule = always
    end
    self.exits[#self.exits + 1] = { exit, rule }
...
function scooby-doo!_night_of_100_frights_location:connect_two_ways_entrance(name, exit, rule)
...
-- acts as a shortcut for 2 connect_one_way_entrance-calls
function scooby-doo!_night_of_100_frights_location:connect_two_ways_entrance_door_stuck(name, exit, rule1, rule2)
...
function scooby-doo!_night_of_100_frights_location:accessibility()
...
-- 
function scooby-doo!_night_of_100_frights_location:discover(accessibility, keys)
...
entry_point = scooby-doo!_night_of_100_frights_location.new("entry_point")
